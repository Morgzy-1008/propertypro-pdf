...
export function CrmKanbanBoard({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 13-Column Kanban Columns Container */}
            ...
            >
              ...
              <div className={`p-3.5 border-b ${
                ...
                <div className="flex items-center justify-between gap-2">
                  <h3 className={`text-xs font-bold tracking-tight truncate ${isLight ? "text-slate-900" : "text-white"}`}>
                    {stage.shortLabel}
                  </h3>
                ...
                <div className={`flex items-center justify-between text-[11px] mt-1 ${isLight ? "text-slate-600" : "text-slate-400"}`}>
                ...
                {stageLeads.length === 0 ? (
                  ...
                  stageLeads.map((lead) => (
                    ...
                    >
                      ...
                      {/* Design & Estate */}
                      <div className={`space-y-1 text-[11px] mb-2.5 ${isLight ? "text-slate-600" : "text-slate-400"}`}>
                        ...
                        <div className="flex items-center gap-1 truncate">
                          <MapPin className="h-3 w-3 text-cyan-500 flex-none" />
                      ...
                      <div className={`pt-2 border-t flex items-center justify-between text-[10px] ${
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-lg bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-500 border border-cyan-500/30 transition-colors"
                          >
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-lg bg-purple-500/10 hover:bg-purple-500/20 text-purple-500 border border-purple-500/30 transition-colors"
                          >
